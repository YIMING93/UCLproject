...
%% the total length of labelfour is  982, the total length of labelseven is 1028
label1 = labelfour(1:eachpoints);
label2 = labelseven(1:eachpoints);
