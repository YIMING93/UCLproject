function [X, fX, i] = sigminimizep(X, f,l,A1,p,SIG, length, varargin)

% Improved minimizep.m for different SIG value
...
[f0 df0] = feval(f, X,l,A1,p, varargin{:});          % get function value and gradient
fX = f0;
  ...
  while 1                             % keep extrapolating as long as necessary
    ...
    while ~success && M > 0
      try
        ...
        [f3 df3] = feval(f, X+x3*s,l,A1,p, varargin{:});
